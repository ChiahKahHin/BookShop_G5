        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('editState', ['id' => $selectedState->id]) }}" method="POST">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <select name="state" id="state"
											...
											<option value="{{ $selectedState->state }}" selected>{{ $selectedState->state }}</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="number" name="delivery_cost" id="delivery_cost"
                                            ...
                                            placeholder="e.g. 10" value="{{ $selectedState->delivery_cost }}" required>
                                        @error('delivery_cost')
                                            <div class="text-danger mt-2 text-sm">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <button class="btn bg-gradient-info w-100 mt-4 md-6" type="submit">Edit
                                        state</button>
                                </div>
                            </div>
                    </div>
